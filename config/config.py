...
EXTRA_PLUGINS_REPO = getenv(
    "EXTRA_PLUGINS_REPO",
    "https://github.com/MISHRAJII123/EXTRAPLUGIN",
)
...
# Your User ID.
OWNER_ID = list(
    map(int, getenv("OWNER_ID", "8128368055").split())
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/MISHRAJII123/RADHAVPSNEW",
)
...
START_IMG_URL = getenv(
    "START_IMG_URL",
    "https://graph.org/file/09d6bac1ef287149a6972-354bff36801cca8a9c.jpg",
)
